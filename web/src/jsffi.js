...
ZC3ZCimplizm3zi0zi0zi0zminplacezmimplizmwasmZCMainZC: async () => (impli.slave.onReadable(() => {const str = impli.slave.read(); return str})),
ZC5ZCimplizm3zi0zi0zi0zminplacezmimplizmwasmZCMainZC: ($1) => (console.log($1)),
